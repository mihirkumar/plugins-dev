...
CKEDITOR.plugins.setLang( 'heading', 'en', {
  ...
  noSiblingWarnings: 'No headings with only one sub-heading',
  siblingWarning: '1 heading with only one sub-heading',
  siblingWarnings: ' headings with only one sub-heading',
